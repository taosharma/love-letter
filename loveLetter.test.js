...
describe("Playing a round", () => {
  ...
  test("A round begins with the active player drawing a card from the deck", () => {
    let game = new Game((numberOfPlayers = 2));
    game.initialiseRound();
    game.playRound();
  ...
  test("A round includes the active player playing a card from their hand, and putting it in their discard pile", () => {
    let game = new Game((numberOfPlayers = 2));
    game.initialiseRound();
    game.playRound();
